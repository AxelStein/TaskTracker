...
public class MenuUtil {
    ...
    public static void setCounterView(Context context, int layoutRes, MenuItem item, int counter) {
        TextView counterView = (TextView) View.inflate(context, layoutRes, null);
        if (counterView != null) {
    ...
    public static void setCounter(MenuItem item, int counter) {
        if (item != null) {
            View actionView = item.getActionView();
            if (actionView instanceof TextView) {
                ((TextView) actionView).setText(counter != 0 ? String.valueOf(counter) : null);
            }
        }
    }
